...
// Global Variables
// ------------------------------------------------
var roomName = "🔵⚪🔵 REAL SOCCER 4vs4 | 🏅 ARSA 🏆";
var roomPassword = null;
var maxPlayers = 28;
var roomPublic = true;
var logWebhook = "https://discord.com/api/webhooks/1056296490705891378/lJpY59Fldf0_A55Thaq7o4PVwplBK2GtudTyh3KJR1jP2aMpxgge3EmDQJ3sXnAliDj5";
var roomWebhook = 'https://discord.com/api/webhooks/1056296815537958962/kHslBoLqOOmaEgC4Q5XhLAfFfxQx-zVMX76pu4FAdd9uQyaOAMSHg6dEcu5QcvnuegFH'; // this webhook is used to send the details of the room (chat, join, leave) ; it should be in a private discord channel
var gameWebhook = 'https://discord.com/api/webhooks/1056297060409811086/QhXFa2C2470kMCykUzYDfaSb7TcYljTBl6K6ikhzcXjwVMwPUVJHW8EaUM7aE_mYxCPp'; // this webhook is used to send the summary of the games ; it should be in a public discord channel
var chatWebhook = 'https://discord.com/api/webhooks/1056297168161488986/q5MehK9PT3kX05OaZn22v10OGlAtoJ_F_buZmxXwmE8ZUU0nHzm-U8Mc7AqJSoR6GUwp'
var ingresosWebhook = 'https://discord.com/api/webhooks/1056297320611860600/DFcWRI1HmlgXfOt9zc78q12bIVZXNOfO69mZtnPrkWQNOzaX7vzWauNFxnWn736H58yT';
var token = "";
var roomLink = "";
var map = "RSR";
		...
		if (team == 1) {
			if (game.lastKickerTeam == 1) { //if goal type is goal
				...
				if (game.secondLastKickerTeam == 1 && game.lastKickerId != game.secondLastKickerId) { // if assist is from teammate
					assister = fraseasis + game.secondLastKickerName;
...
},
{
    ...
    Auth: "d9wsnguuxfzJd1rglCeNfm4sk0bfe3wvlrFX1R47ajE",
    Conn: "3139302E32372E31302E323239"
}];
